...
class TestPrometheusConfig:
    ...
    def test_custom_config(self):
        ...
        config = PrometheusConfig(default_labels={"env": "test"}, registry=registry)
...
class TestPrometheusMetrics:
    ...
    def test_init_with_custom_config(self):
        ...
        registry = CollectorRegistry()
        config = PrometheusConfig(default_labels={"service": "test"}, registry=registry)
    ...
    def test_error_handling_in_counter(self):
        ...
        with patch.object(
            metrics, "_get_or_create_counter", side_effect=Exception("Test error")
        ):
    ...
    def test_error_handling_in_gauge(self):
        ...
        # This should not raise an exception
        with patch.object(
            metrics, "_get_or_create_gauge", side_effect=Exception("Test error")
        ):
