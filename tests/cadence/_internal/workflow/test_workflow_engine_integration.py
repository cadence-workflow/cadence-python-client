...
class TestWorkflowEngineIntegration:
    ...
    def workflow_engine(self, mock_client, workflow_info, mock_workflow_func):
        ...
        return WorkflowEngine(
            info=workflow_info, client=mock_client, workflow_func=mock_workflow_func
        )
    ...
    def test_execute_workflow_function_sync(self, workflow_engine):
        ...
        result = workflow_engine._execute_workflow_function_once(
            workflow_engine._workflow_func, input_data
        )
    ...
    def test_workflow_engine_initialization(
        self, workflow_engine, workflow_info, mock_client, mock_workflow_func
    ):
    ...
    @pytest.mark.asyncio
    async def test_workflow_engine_without_workflow_func(
        self, mock_client, workflow_info
    ):
        """Test WorkflowEngine without workflow function."""
        engine = WorkflowEngine(
            info=workflow_info, client=mock_client, workflow_func=None
        )
