...
class ChildWorkflowExecutionStateMachine(BaseDecisionStateMachine):
    ...
    def initiated_event_id(self) -> int | None:
    ...
    def set_initiated_event_id(self, initiated_event_id: int) -> None:
        self._initiated_event_id = initiated_event_id

    @child_workflow_events.event(event_id_is_alias=True)
    ...
    @child_workflow_events.event("initiated_event_id")
