...
from cadence.api.v1 import decision_pb2 as _decision_pb2
...
class PollForDecisionTaskResponse(_message.Message):
    ...
    def __init__(self, task_token: _Optional[bytes] = ..., workflow_execution: _Optional[_Union[_common_pb2.WorkflowExecution, _Mapping]] = ..., workflow_type: _Optional[_Union[_common_pb2.WorkflowType, _Mapping]] = ..., previous_started_event_id: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., started_event_id: _Optional[int] = ..., attempt: _Optional[int] = ..., backlog_count_hint: _Optional[int] = ..., history: _Optional[_Union[_history_pb2.History, _Mapping]] = ..., next_page_token: _Optional[bytes] = ..., query: _Optional[_Union[_query_pb2.WorkflowQuery, _Mapping]] = ..., workflow_execution_task_list: _Optional[_Union[_tasklist_pb2.TaskList, _Mapping]] = ..., scheduled_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., started_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., queries: _Optional[_Mapping[str, _query_pb2.WorkflowQuery]] = ..., next_event_id: _Optional[int] = ..., total_history_bytes: _Optional[int] = ..., auto_config_hint: _Optional[_Union[AutoConfigHint, _Mapping]] = ...) -> None: ...
...
class PollForActivityTaskResponse(_message.Message):
    ...
    auto_config_hint: AutoConfigHint
    def __init__(self, task_token: _Optional[bytes] = ..., workflow_execution: _Optional[_Union[_common_pb2.WorkflowExecution, _Mapping]] = ..., activity_id: _Optional[str] = ..., activity_type: _Optional[_Union[_common_pb2.ActivityType, _Mapping]] = ..., input: _Optional[_Union[_common_pb2.Payload, _Mapping]] = ..., scheduled_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., started_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., schedule_to_close_timeout: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., start_to_close_timeout: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., heartbeat_timeout: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., attempt: _Optional[int] = ..., scheduled_time_of_this_attempt: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., heartbeat_details: _Optional[_Union[_common_pb2.Payload, _Mapping]] = ..., workflow_type: _Optional[_Union[_common_pb2.WorkflowType, _Mapping]] = ..., workflow_domain: _Optional[str] = ..., header: _Optional[_Union[_common_pb2.Header, _Mapping]] = ..., auto_config_hint: _Optional[_Union[AutoConfigHint, _Mapping]] = ...) -> None: ...
